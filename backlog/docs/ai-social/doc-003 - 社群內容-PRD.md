...
| 3 | 頂部下拉或返回動態牆時載入新貼文 | 別人剛發的貼文在重新載入後出現在最上方 |
| 4 | 貼文卡：頭像（handle 首字＋固定色）、顯示名稱、handle、相對時間、內容、語氣標籤與改寫幅度、讚數、留言數 | 所有欄位齊備，點卡片進入貼文頁 |
...
| # | 功能／需求 | 完成目標 |
|---|---|---|
| 1 | 自己的個人頁：頭像、顯示名稱、handle、貼文列表（時間序）、進入設定 | 貼文全部顯示原文 |
