...
const TONE_DEFINITIONS = [
  ...
  },
  {
    ...
    sample: '如果會議沒有重點。\n\n那重點。\n\n就是會議沒有重點。',
    instruction: '用黃山料體重述：句子要短，每句盡量像看似深刻、細想又像廢話的金句，句與句之間用空一行的換行留白製造情緒停頓。可以使用「如果 A，那 B 就是 C」、「不是 A，而是 B」、「你以為是 A，其實是 B」這類句型，A、B、C 換成原文裡的內容。標點只用句號、逗號與問號，不要使用刪節號「…」或連續的點。必須保留原文所有關鍵事實、數字、人物、立場與結論；不要新增原文沒有的故事、承諾、攻擊或結論，也不要把語意改成雞湯或勵志文。'
  },
  {
    id: 'caige',
    label: '財哥體',
